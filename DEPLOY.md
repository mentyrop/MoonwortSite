...
Лендинг — это **статика** (`index.html` + внешние шрифты). Никакой сборки, БД
и бэкенда. Задача: отдавать `index.html` по адресу `https://moonwort.ru`.
...
# для хостинга нужен только moonwort-site/index.html
```
